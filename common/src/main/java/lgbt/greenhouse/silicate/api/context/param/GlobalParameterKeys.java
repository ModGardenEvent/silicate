...
public final class GlobalParameterKeys {
	public static final GlobalParameterKey<Entity> THIS_ENTITY = register("this_entity", Entity.class);
	/**
	 * A temporary parameter type typically used in {@link EntityPassengerPredicate}.
	 */
	public static final GlobalParameterKey<Entity> PASSENGER_ENTITY = register("passenger_entity", Entity.class);
	/**
	 * A temporary parameter type typically used in {@link EntityVehiclePredicate}.
	 */
	public static final GlobalParameterKey<Entity> VEHICLE_ENTITY = register("vehicle_entity", Entity.class);
	/**
	 * A temporary parameter type typically used in {@link EntityProjectileOwnerPredicate} and {@link EntityTameOwnerPredicate}.
	 */
	public static final GlobalParameterKey<Entity> OWNER_ENTITY = register("owner_entity", Entity.class);
	/**
	 * The aggressor in an attacker-victim scenario.
	 */
	public static final GlobalParameterKey<Entity> ATTACKING_ENTITY = register("attacking_entity", Entity.class);
	/**
	 * The victim in an attacker-victim scenario.
	 */
	public static final GlobalParameterKey<Entity> VICTIM_ENTITY = register("victim_entity", Entity.class);
	public static final GlobalParameterKey<Vec3> ORIGIN = register("origin", Vec3.class);
	public static final GlobalParameterKey<BlockState> BLOCK_STATE = register("block_state", BlockState.class);
	public static final GlobalParameterKey<BlockEntity> BLOCK_ENTITY = register("block_entity", BlockEntity.class);
	public static final GlobalParameterKey<Unit> UNIT = new GlobalParameterKey<>(id("unit"), Unit.class);
	...
	private static <T> GlobalParameterKey<T> register(String name, Class<T> clazz) {
		return Registry.register(
				...
				id(name),
				new GlobalParameterKey<>(id(name), clazz)
		);
	}
}

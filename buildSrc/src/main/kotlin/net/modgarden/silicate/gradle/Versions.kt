...
object Versions {
	...
	const val MOD_CHANNEL = "BETA"

	const val MINECRAFT = "1.21.10"
	const val PARCHMENT_MINECRAFT = "1.21.10"
	const val NEOFORM = "$MINECRAFT-20251010.172816"
	const val PARCHMENT = "2025.10.12"

	const val FABRIC_API = "0.138.3+1.21.10"
	const val FABRIC_LOADER = "0.17.3"
	const val MOD_MENU = "16.0.0-rc.1"
	...
	const val NEOFORGE_MINECRAFT_RANGE = "[1.21.8]"

	const val FABRIC_MIXIN = "0.16.3+mixin.0.8.7"
	const val MIXIN_EXTRAS = "0.5.0"
